...
export const CinematicCanvas: React.FC<CinematicCanvasProps> = ({ activeChapter }) => (
  <div className="pointer-events-none fixed inset-0 z-0 overflow-hidden bg-[#03060f]">
    ...
    {activeChapter === 4 && (
      <svg viewBox="0 0 640 420" className="absolute bottom-0 left-1/2 hidden h-[62vh] w-[1100px] -translate-x-1/2 opacity-55 md:block" aria-hidden="true">
        <defs>
          <linearGradient id="lighthouse-beam-left" x1="1" y1="0" x2="0" y2="0">
        ...
        <path d="M310 105 L28 20 L28 190 Z" fill="url(#lighthouse-beam-left)" />
